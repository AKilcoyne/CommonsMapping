...
write.table(zonal_stats_seg, "zonal_stats/zonal_stats_seg_20170829_MASKED_NORMAL.txt", sep="\t")
...
{
  zonal_stats_seg <- read.table("zonal_stats/zonal_stats_seg_20170829_MASKED_NORMAL.txt", sep="\t", header=T, as.is=T)
}
#segmentation.raster <-raster("Segmentation/Segmentation_LARGE_Rasterised.tif")
segmentation.raster <-raster("Segmentation/Segmentation_Rasterised.tif")
#segmentation.raster <-raster("Segmentation/Test_Segmentation_Rasterised.tif")
...
for(c in unique(training.data.all$PRIHAB))
{
  ...
  prb <- ifelse(training.data.sub$DOMINANCE == 1,0.85, ifelse(training.data.sub$DOMINANCE == 2, 0.75, 0.20))
...
write.table(training.data, "training_data/training_data_20170829_MASKED_NORMAL.txt", sep="\t")
write.table(training.data.test, "training_data/training_data_test_20170829_MASKED_NORMAL.txt", sep="\t")
...
training.data <- read.table("training_data/training_data_20170829_MASKED_NORMAL.txt", sep="\t", header=T)
training.data.test <- read.table("training_data/training_data_test_20170829_MASKED_NORMAL.txt", sep="\t", header=T)
...
writeOGR(segmentation.p,
         "Outputs/CommonsMapping_20170829_MASKED_NORMAL.shp",
         "CommonsMapping_20170829_MASKED_NORMAL",
