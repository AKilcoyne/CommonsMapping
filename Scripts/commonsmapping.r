...
S2_winter <- "S2/s2_20151229_137_mask.tif"
WV2_summer <- "WV2/SHER_8BAND_MS_20150409_mask.tif"
SPOT_summer <- "SPOT/SPOT_SHER_4BAND_MS_20150611_mask.tif"
height <- "Height/IHM_05m_AOI_BNG.tif"
slope <- "Height/IHM_05m_AOI_BNG_slope.tif"
aspect <- "Height/IHM_05m_AOI_BNG_aspect.tif"
sar_summer <- "S1/S1A_IW_GRDH_1SDV_20150503T061321_20150503T061526_005753_007632_FD40_AOI.tif"
sar_winter <- "S1/S1A_IW_GRDH_1SDV_20151229T061338_20151229T061518_009253_00D59B_F24A_AOI.tif"
LSU_summer <- "LSU/SHER_8BAND_MS_20150409_mask_unmixed.tif"
LSU_winter <- "LSU/s2_20151229_137_mask_unmixed.tif"
OS_dist_building <- "OS/Proximity_Building.tif"
OS_dist_road <- "OS/Proximity_Road.tif"
OS_dist_surfacewaterline <- "OS/Proximity_SurfaceWaterLine.tif"
OS_dist_surfacewaterarea <- "OS/Proximity_SurfaceWaterArea.tif"
OS_dist_woodland <- "OS/Proximity_Woodland.tif"
bioclim_max_temp <- "Bioclim/bio2_30s_05_maxtemp_BNG27700.tif"
bioclim_min_temp <- "Bioclim/bio2_30s_06_mintemp_BNG27700.tif"
bioclim_annual_rainfall <- "Bioclim/bio2_30s_12_annaulrainfall_BNG27700.tif"
moorlandline_dist <- "MoorlandLine/Proximity_MoorlandLineRaster.tif"
...
zonal_stats_seg <- write.table(zonal_stats_seg, "Zonal_stats/zonal_stats_seg_20170720.txt", sep="\t")
zonal_stats_seg <- read.table("Zonal_stats/zonal_stats_seg_20170720.txt", sep="\t", header=T)
...
write.table(zonal_stats_seg, "zonal_stats/zonal_stats_seg_20170720.txt", sep="\t")
...
{
  zonal_stats_seg <- read.table("zonal_stats/zonal_stats_seg_20170720.txt", sep="\t", header=T, as.is=T)
}
...
for(c in unique(training.data.all$PRIHAB))
{
  ...
  prb <- ifelse(training.data.sub$DOMINANCE == 1,0.75,0.25)
...
i <- colnames(training.data) %in% c(rownames(M.rf.detailed.all$importance)[order(M.rf.detailed.all$importance, decreasing=T)][1:42],"PRIHAB")
...
writeOGR(segmentation.p,
         "Outputs/CommonsMapping_20170720.shp",
         "CommonsMapping_20170720",
